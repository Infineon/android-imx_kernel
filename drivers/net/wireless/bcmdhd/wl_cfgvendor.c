...
#define CONFIG_ANDROID_VERSION 13
		...
		struct wireless_dev *wdev, const void  *data, int len)
{
	...
	printk("SwapX wl_cfgvendor_dbg_trigger_mem_dump \n");
		...
		struct wireless_dev *wdev, const void *data, int len)
{
	...
	printk("SwapX wl_cfgvendor_dbg_get_mem_dump\n");
	...
	struct wireless_dev *wdev, const void  *data, int len)
{
	...
	printk(" SwapX wl_cfgvendor_dbg_start_logging \n");
	...
	struct wireless_dev *wdev, const void  *data, int len)
{
	...
	printk(" SwapX wl_cfgvendor_dbg_reset_logging \n");
	...
	struct wireless_dev *wdev, const void  *data, int len)
{
	...
	printk(" SwapX wl_cfgvendor_dbg_get_ring_status ");
	...
	struct wireless_dev *wdev, const void  *data, int len)
{
	...
	printk(" SwapX wl_cfgvendor_dbg_get_ring_data \n");
